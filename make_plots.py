...
#    '2LSS1b':       ('n_jet>=4 && n_bjet>=1','(lep_pt[0]>27e3 && (el_trigger || mu_trigger) && (n_baseel+n_basemu)==2 && n_lep==2 && lep_charge[0]*lep_charge[1]>0 && Sum$(lep_passECIDS==0)==0 && (n_el!=2 || Alt$(dilep_m[0],0)<81e3 || Alt$(dilep_m[0],0)>101e3))*(sf_total * sf_el_trigger * sf_mu_trigger*sf_el_ECIDS )', "SS 4j1b"),
